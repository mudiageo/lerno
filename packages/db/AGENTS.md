...
### Schema Organization
Schemas are modular and located in [src/schema/](file:///c%3A/Users/Admin/lerno/packages/db/src/schema/):
- [users.ts](file:///c%3A/Users/Admin/lerno/packages/db/src/schema/users.ts): Core user profiles.
- [posts.ts](file:///c%3A/Users/Admin/lerno/packages/db/src/schema/posts.ts): Feed, shorts, and video metadata.
- [courses.ts](file:///c%3A/Users/Admin/lerno/packages/db/src/schema/courses.ts): Course content and enrollment.
- [auth.ts](file:///c%3A/Users/Admin/lerno/packages/db/src/schema/auth.ts): Session and account management (NextAuth compatible).
...
- **Imports**: Export all new schemas from [src/schema/index.ts](file:///c%3A/Users/Admin/lerno/packages/db/src/schema/index.ts).
